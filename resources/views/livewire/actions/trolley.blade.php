<div class="dropdown dropdown-end">
    <div tabindex="0" role="button" class="btn btn-ghost btn-circle">
        <div class="indicator">
            ...
            @if ($cartCount || $cartHotelCount > 0)
            <span class="badge badge-sm indicator-item bg-base-100/50"> <span
                    class="text-warning">{{$cartCount}} {{$cartHotelCount}}</span></span>
            @else
    ...
    <div tabindex="0" class="card card-compact dropdown-content bg-base-100 z-1 mt-3 w-52 shadow">
        <div class="card-body">
            @if ($cartCount || $cartHotelCount)
            <span class="text-lg font-bold">{{$cartCount}} {{$cartHotelCount}} Items</span>
            @else
