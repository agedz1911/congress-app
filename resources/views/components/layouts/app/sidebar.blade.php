    ...
    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            <flux:navlist.group :heading="__('Platform')" class="grid">
                ...
                <flux:navlist.item icon="document-text" :href="route('myregistrations')" :current="request()->routeIs(['myregistrations', 'order.detail', 'order.confirm'])" wire:navigate>{{ __('My Registration') }}</flux:navlist.item>
            </flux:navlist.group>
        </flux:navlist>
